...
def get_metrics(labels, predicted_labels, class_labels = None):
    accuracy = accuracy_score(labels, predicted_labels)
    confuse = confusion_matrix(labels, predicted_labels, labels = class_labels)
...
if __name__ == "__main__":
    ...
    class_labels = ["false", "mixture", "true", "unproven"]
    accuracy, confuse = get_metrics(labels.numpy(), predicted_labels, class_labels)
